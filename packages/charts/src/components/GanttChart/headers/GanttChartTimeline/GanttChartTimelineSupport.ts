...
const getQuartersMonths = (start: Date, end: Date): QuarterMonths[] => {
  const result: QuarterMonths[] = [];
...
const getYearsQuarters = (quartersMonths: QuarterMonths[]): YearQuarters[] => {
  const result: YearQuarters[] = [];
...
export const prepareTimelineData = (contractDuration: DateRange): TimelineData => {
