...
export const ColumnChartWithTrendPlaceholder = (props) => {
  return (
    ...
    React.createElement(
      ...
      React.createElement('rect', { x: '20', y: '65', width: '15', height: '70' }),
      React.createElement('rect', { x: '40', y: '58', width: '15', height: '77' }),
      React.createElement('rect', { x: '60', y: '68', width: '15', height: '67' }),
      React.createElement('rect', { x: '80', y: '60', width: '15', height: '75' }),
      React.createElement('rect', { x: '100', y: '35', width: '15', height: '100' }),
