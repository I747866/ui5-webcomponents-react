...
const lineContentVertical = React.createElement(
  React.Fragment,
  null,
...
const lineContentHorizontal = React.createElement(
  React.Fragment,
  null,
  React.createElement('path', {
...
export const ComposedChartPlaceholder = ({ layout, measures }) => {
  ...
  return (
    ...
    React.createElement(
      ...
      layout === 'horizontal' && (distinctElements.has('line') || distinctElements.has('area')) && lineContentHorizontal
    )
  );
};
