...
interface GanttChartAnnotationProps extends CommonProps {
  /**
   ...
   * __rowHeight__ of the `GanttChart` is used.
   */
  rowHeight?: number;
  /**
 ...
 */
declare const GanttChartAnnotation: React.ForwardRefExoticComponent<
  GanttChartAnnotationProps & React.RefAttributes<HTMLDivElement>
>;
